...
export default function calcTarifaBranca(
  ...
  const { totalTimeWeekdays, tempoLigadoWeekend } = onTimeAtEachInterval(
  ...
  let kwGastoIntermediarioWeekdays = calcularKWMonthly(
    power,
    quantity,
    totalTimeWeekdays.tempoLigadoIntermediarioWeekdays,
    frequencyOfUseOnWeekdays,
  );

  let kwGastoPontaWeekdays = calcularKWMonthly(
    power,
    quantity,
    totalTimeWeekdays.tempoLigadoPontaWeekdays,
    frequencyOfUseOnWeekdays,
  );

  let kwGastoForaDePontaWeedays = calcularKWMonthly(
    power,
    quantity,
    totalTimeWeekdays.tempoLigadoForaDePontaWeekdays,
    frequencyOfUseOnWeekdays,
  );

  // Calcula a quantidade de KWh gasto em cada intervalos durante o final de semana
  let kwGastoWeekend = calcularKWMonthly(
    power,
    quantity,
    tempoLigadoWeekend,
    frequencyOfUseOnWeekend,
  ...
  const totalAPagarSemana =
    kwGastoIntermediarioWeekdays * valorIntermediaria +
